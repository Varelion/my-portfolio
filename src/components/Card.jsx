    ...
    <>
      ...
      >
        ...
        <div className="p-5">
          ...
          <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
            This portfolio implements a sleek, dynamic front-end with Postgresql
            as a back-end solution. It is hosted on an AWS Cloud EC2 instance.
            It also sports a custom e-mail solution to notify me through half a
            dozen devices of any messages left here through the 'contact'
            section below.
          </p>
          <a
      ...
      >
        ...
        <div className="p-5">
          ...
          <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
            In a Dungeons & Dragons server I'm in, a user may 'gamble' and
            'work' 8 hours to earn gold. Well, this script routinely sends an
            HTTP Post request with the appropriate token and header data to act
            as though it's a real user.
          </p>
          <a
      ...
      >
        ...
        <div className="p-5">
          ...
          <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
            A complete PERN-stack application I am hosting through AWS. I'm not
            bothering with HTTPS, as this is just a proof of concept -- unlike
            my portfolio site. It incorporates a calendar solution, color
            palette, secure database, and a rather smooth UX.
          </p>
          <a
      ...
      >
        ...
        <div className="p-5">
          ...
          <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
            This one is quite cheeky -- utilizing Python, Github's API, and
            BASH's 'cron' command line task automation, I created something to
            commit a random number of commits per day, giving me an artificial
            activity boost. Some might see this as contentious, I see it as a
            mixture of two sayings "Modern problems require modern solutions",
            and Bear Grills' "Improvise. Adapt. Overcome."
          </p>
          <a
            href="https://github.com/Varelion"
            className="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-500 rounded-lg hover:bg-blue-200 focus:ring-4 focus:outline-none focus:ring-blue-300"
